...
| --- | --- | --- |
| bring-up transcript | mode=paused, track=1, volume=18, order=repeat_all | display 3:16000Hz 2ch P0% -> status=paused track=1 volume=18 order=repeat_all rate=16000Hz channels=2 progress=0 -> link rx=6 status=1 display=1 bad=0 last=k uptime=1234ms -> input ecw=0 eccw=0 eb=0 elong=0 s1=0 s1l=0 s2=0 s2l=0 s4=0 s4l=0 |
...
| Android parser markers | status=, progress=, display 1:, display 2:, display 3:, link , input  |
