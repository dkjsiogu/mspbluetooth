...
| Recent event trace | Firmware `x` command reports the recent BT/EC11/local-button event ring, and APK renders it in the Trace panel | `tools/bluetooth_protocol_sim.py`, `tools/board_scenario_sim.py`, `tools/android_ui_parser_sim.py`, `tools/end_to_end_demo_sim.py` |
