...
`link rx=...`, `input ecw=...`, `pin bt tx=P4.4 rx=P4.5`, `tone start`,
...
display frame, track-list, Link, Input, Wiring, and `Acceptance X/9` summary panels update
