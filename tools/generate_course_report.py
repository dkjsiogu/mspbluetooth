...
- 验证工具：`tools/` 提供固件构建、注释规范检查、协议仿真、整板场景仿真、按键长按仿真、墨水屏预览和交付打包。
...
验证覆盖固件 clean build、RAM 余量、头文件/源码注释规范、关键命令、引脚冲突说明、蓝牙协议仿真、整板场景仿真、本地按键长按仿真、墨水屏预览图生成、TF WAV 资产格式校验、Android APK 构建和权限检查。
